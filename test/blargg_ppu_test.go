...
func Test_blarggPPU(t *testing.T) {
	...
	sramTests := []struct {
		...
		},
		{
			...
			"roms/sprite_overflow_tests/2.Details.nes",
			msgTypePPUVRAM,
			-1,
			"SPRITE OVERFLOW DETAILS\nPASSED",
		},
		{
			...
			"roms/sprite_overflow_tests/3.Timing.nes",
			msgTypePPUVRAM,
			-1,
			"SPRITE OVERFLOW TIMING\nFAILED: #5",
		},
		{
			...
			"roms/sprite_overflow_tests/4.Obscure.nes",
			msgTypePPUVRAM,
			-1,
			"SPRITE OVERFLOW OBSCURE\nFAILED: #2",
		},
		{
			...
			"roms/sprite_overflow_tests/5.Emulator.nes",
			msgTypePPUVRAM,
			-1,
		...
		{
			"sprite hit basics",
			"roms/sprite_hit_tests_2005.10.05/01.basics.nes",
			msgTypePPUVRAM,
			-1,
			"SPRITE HIT BASICS\nPASSED",
		},
		{
			...
			"roms/sprite_hit_tests_2005.10.05/02.alignment.nes",
			msgTypePPUVRAM,
			-1,
			"SPRITE HIT ALIGNMENT\nPASSED",
		},
		{
			"sprite hit corners",
			"roms/sprite_hit_tests_2005.10.05/03.corners.nes",
			msgTypePPUVRAM,
			-1,
			"SPRITE HIT CORNERS\nPASSED",
		},
		{
			"sprite hit flip",
			"roms/sprite_hit_tests_2005.10.05/04.flip.nes",
			msgTypePPUVRAM,
			-1,
			"SPRITE HIT FLIPPING\nPASSED",
		},
		{
			...
			"roms/sprite_hit_tests_2005.10.05/05.left_clip.nes",
			msgTypePPUVRAM,
			-1,
		...
		},
		{
			...
			"roms/sprite_hit_tests_2005.10.05/06.right_edge.nes",
			msgTypePPUVRAM,
			-1,
			"SPRITE HIT RIGHT EDGE\nPASSED",
		},
		{
			...
			"roms/sprite_hit_tests_2005.10.05/07.screen_bottom.nes",
			msgTypePPUVRAM,
			-1,
			"SPRITE HIT SCREEN BOTTOM\nPASSED",
		},
		{
			...
			"roms/sprite_hit_tests_2005.10.05/08.double_height.nes",
			msgTypePPUVRAM,
			-1,
			"SPRITE HIT DOUBLE HEIGHT\nPASSED",
		},
		{
			...
			"roms/sprite_hit_tests_2005.10.05/09.timing_basics.nes",
			msgTypePPUVRAM,
			-1,
			"SPRITE HIT TIMING\nPASSED",
		},
		{
			...
			"roms/sprite_hit_tests_2005.10.05/10.timing_order.nes",
			msgTypePPUVRAM,
			-1,
			"SPRITE HIT ORDER\nPASSED",
		},
		{
			...
			"roms/sprite_hit_tests_2005.10.05/11.edge_timing.nes",
			msgTypePPUVRAM,
			-1,
			"SPRITE HIT EDGE TIMING\nPASSED",
		},
