...
// [6502 Instruction Reference]: https://www.nesdev.org/obelisk-6502-guide/reference.html
var OpCodes = []OpCode{
	{0x00, "BRK", 1, 7, Implicit, brk},
	{0x90, "BCC", 2, 2 /*+1 if branch succeeds, +2 if to a new page*/, Implicit, bcc},
	{0xB0, "BCS", 2, 2 /*+1 if branch succeeds, +2 if to a new page*/, Implicit, bcs},
	{0xF0, "BEQ", 2, 2 /*+1 if branch succeeds, +2 if to a new page*/, Implicit, beq},
	{0x30, "BMI", 2, 2 /*+1 if branch succeeds, +2 if to a new page*/, Implicit, bmi},
	{0xD0, "BNE", 2, 2 /*+1 if branch succeeds, +2 if to a new page*/, Implicit, bne},
	{0x10, "BPL", 2, 2 /*+1 if branch succeeds, +2 if to a new page*/, Implicit, bpl},
	{0x50, "BVC", 2, 2 /*+1 if branch succeeds, +2 if to a new page*/, Implicit, bvc},
	{0x70, "BVS", 2, 2 /*+1 if branch succeeds, +2 if to a new page*/, Implicit, bvs},
	{0x18, "CLC", 1, 2, Implicit, clc},
	{0xD8, "CLD", 1, 2, Implicit, cld},
	{0x58, "CLI", 1, 2, Implicit, cli},
	{0xB8, "CLV", 1, 2, Implicit, clv},
	{0xCA, "DEX", 1, 2, Implicit, dex},
	{0x88, "DEY", 1, 2, Implicit, dey},
	{0xE8, "INX", 1, 2, Implicit, inx},
	{0xC8, "INY", 1, 2, Implicit, iny},
	{0x20, "JSR", 3, 6, Implicit, jsr},
	{0xEA, "NOP", 1, 2, Implicit, nop},
	{0x48, "PHA", 1, 3, Implicit, pha},
	{0x08, "PHP", 1, 3, Implicit, php},
	{0x68, "PLA", 1, 4, Implicit, pla},
	{0x28, "PLP", 1, 4, Implicit, plp},
	{0x40, "RTI", 1, 6, Implicit, rti},
	{0x60, "RTS", 1, 6, Implicit, rts},
	{0x38, "SEC", 1, 2, Implicit, sec},
	{0xF8, "SED", 1, 2, Implicit, sed},
	{0x78, "SEI", 1, 2, Implicit, sei},
	{0xAA, "TAX", 1, 2, Implicit, tax},
	{0xA8, "TAY", 1, 2, Implicit, tay},
	{0xBA, "TSX", 1, 2, Implicit, tsx},
	{0x8A, "TXA", 1, 2, Implicit, txa},
	{0x9A, "TXS", 1, 2, Implicit, txs},
	{0x98, "TYA", 1, 2, Implicit, tya},
