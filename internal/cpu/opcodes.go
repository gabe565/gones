...
var OpCodes = []OpCode{
	...
	0x61: {"ADC", 0x61, 2, 2, IndirectX, adc},
	0x65: {"ADC", 0x65, 2, 2, ZeroPage, adc},
	0x69: {"ADC", 0x69, 2, 2, Immediate, adc},
	0x6D: {"ADC", 0x6D, 3, 3, Absolute, adc},
	0x71: {"ADC", 0x71, 2, 2 /*+1 if page crossed*/, IndirectY, adc},
	0x75: {"ADC", 0x75, 2, 2, ZeroPageX, adc},
	0x79: {"ADC", 0x79, 3, 3 /*+1 if page crossed*/, AbsoluteY, adc},
	0x7D: {"ADC", 0x7D, 3, 3 /*+1 if page crossed*/, AbsoluteX, adc},
	...
	0x1E: {"ASL", 0x1E, 3, 7 /*+1 if page crossed*/, AbsoluteX, asl},
	...
	0x18: {"CLC", 0x18, 1, 2, Implied, clc},
	0xD8: {"CLD", 0xD8, 1, 2, Implied, cld},
	0x58: {"CLI", 0x58, 1, 2, Implied, cli},
	0xB8: {"CLV", 0xB8, 1, 2, Implied, clv},
	...
	0xCA: {"DEX", 0xCA, 1, 2, Implied, dex},
	0x88: {"DEY", 0x88, 1, 2, Implied, dey},
	...
	0x48: {"PHA", 0x48, 1, 3, Implied, pha},
	0x08: {"PHP", 0x08, 1, 3, Implied, php},
	0x68: {"PLA", 0x68, 1, 4, Implied, pla},
	0x28: {"PLP", 0x28, 1, 4, Implied, plp},
	...
	0x40: {"RTI", 0x40, 1, 6, Implied, rti},
	0x60: {"RTS", 0x60, 1, 6, Implied, rts},
	...
	0x38: {"SEC", 0x38, 1, 2, Implied, sec},
	0xF8: {"SED", 0xF8, 1, 2, Implied, sed},
	0x78: {"SEI", 0x78, 1, 2, Implied, sei},
	...
	0xAA: {"TAX", 0xAA, 1, 2, Implied, tax},
	0xA8: {"TAY", 0xA8, 1, 2, Implied, tay},
	0xBA: {"TSX", 0xBA, 1, 2, Implied, tsx},
	0x8A: {"TXA", 0x8A, 1, 2, Implied, txa},
	0x9A: {"TXS", 0x9A, 1, 2, Implied, txs},
	0x98: {"TYA", 0x98, 1, 2, Implied, tya},
}
